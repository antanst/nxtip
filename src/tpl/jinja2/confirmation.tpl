...
{%   set coin_amount_fmt = " __^%s%.9g ^%s%ss__" % (amount_prefix_short, coin_amount, amount_prefix_long, coin_name) %}
{% endif %}
{% if a.fiatval: %}
...
^New ^to ^NXT? ^Check ^out ^[nxtcrypto.org](http://nxtcrypto.org) ^and ^/r/NXT
{% endif %}
